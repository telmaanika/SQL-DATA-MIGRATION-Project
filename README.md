...
**My Notes:**  
 I built this to practice automating routine checks that a data team would normally do manually before loading files into systems.
...
**My Notes:**  
 I chose PowerShell because it is widely used in enterprise environments for automation, especially with Windows-based systems.
...
**My Notes**
 I used a JSON config so paths and patterns can be updated without changing the script logic.
...
**My Notes**
 Archiving files after validation keeps the input folder clean and makes the process more production-like.
...
**My Notes**
 Working on this helped me get more comfortable with PowerShell syntax, loops, and working with CSV data in an automated way.
